...
* Python (FastAPI, TensorFlow, pandas)
* Deep Learning (MobileNetV2, DistilBERT)

バックエンドはEC2でFastAPIによりAPIサーバを構築、機械学習を実行。

フロントエンドはVue.jsで作り、S3とCloudFrontを使用し公開。